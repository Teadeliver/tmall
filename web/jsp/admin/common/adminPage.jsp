...
<div class="container text-center">
    <nav aria-label="...">
        <jsp:useBean id="pagination" scope="request" type="util.Pagination"/>
        <ul class="pagination">
            ...
            <li class="page-item ${pagination.hasPrevious ? '':'disabled'}">
                <a class="page-link"
                   href="?pageStart=${pagination.start-pagination.count<0?0:pagination.start-pagination.count}${pagination.param}"
                   tabindex="-1">‹</a>
            </li>
